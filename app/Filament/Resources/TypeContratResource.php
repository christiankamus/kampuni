...
use App\Filament\Resources\TypeContratResource\Pages;
use App\Filament\Resources\TypeContratResource\RelationManagers;

class TypeContratResource extends Resource
{
    protected static ?string $model = Type_Contrat::class;
    ...
    {
        return [
            'index' => Pages\ManageTypeContrats::route('/'),
        ];
    }    
}
